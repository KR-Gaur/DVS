...
<div>
	...
	<button class="button button1" style="background-color:rgb(255,40,40);color:white;border: 2px solid rgb(255,0,0);margin-left: 0px;">Back </button>
	</form>
	<form name="delete_candidate_script" action="delete_candidate_script.php" method="post">

		<tr><td><label style="position:absolute;top:44%;left:25%;font-size: 20px;" >Candidate ID :</label> 
	        <td><input style="position:absolute;top:42%;left:40%;" type="tel" onkeypress="return isNumberKey(event)" name="DEL_CANDIDATE_ID" minlength="6" maxlength="6" />   
	        <br>
